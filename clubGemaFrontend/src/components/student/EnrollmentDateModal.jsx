    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-[#0f172a]/80 backdrop-blur-md p-6">
      ...
      <div className="bg-white w-full max-w-[400px] rounded-[3rem] relative z-10 animate-in zoom-in-95 duration-300 flex flex-col max-h-[85vh] shadow-2xl border-4 border-white overflow-hidden">
        ...
        <div className="p-8 pb-4 text-center">
          ...
          <h2 className="text-2xl font-black text-[#1e3a8a] uppercase italic tracking-tighter leading-none">Selecciona tu fecha de inicio</h2>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-8 scrollbar-hide text-center">
          ...
          <div>
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Inicio Temprano</span>
            </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        ...
                        {f.isContinuacion ? (
                          ...
                          <p className="text-[9px] font-bold text-slate-400 uppercase">Semana Actual</p>
                        )}
                      </div>
                    </div>
          ...
          <div className="pb-6">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Inicio tardío</span>
            </div>
            <div className="grid grid-cols-1 gap-3">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-[9px] font-bold text-slate-400 uppercase">Semana Siguiente</p>
                      </div>
                    </div>
